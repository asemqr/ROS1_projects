...
def main():
    ...
    pubs = [
        rospy.Publisher('/motortom2m/command', Float64, queue_size=10),  # First joint
        rospy.Publisher('/joint2/command', Float64, queue_size=10),      # Second joint (set to 0)
        rospy.Publisher('/joint4/command', Float64, queue_size=10),      # Third joint
        rospy.Publisher('/joint6/command', Float64, queue_size=10),      # Fourth joint (set to 0)
        rospy.Publisher('/end/command', Float64, queue_size=10)          # Fifth joint
    ]
